...
import sys
sys.path.append('/home/roberto/PythonProjects/RDetector/EasyDet/')
...
def window_partition(
    ...
    # Check if window_size evenly divides the height and width
    if H % window_size[0] != 0 or W % window_size[1] != 0:
        raise ValueError("Window size does not evenly divide the height and width of the image")
    ...
    def __init__(
        ...
        self.main_path = nn.Sequential(
            ...
            DepthwiseSeparableConv(in_channels=in_channels,
                                   out_channels=int(out_channels * expand_ratio // 2) if downscale else int(
...
class RelativeSelfAttention(nn.Module):
    ...
    def __init__(
        ...
        assert in_channels % num_heads == 0, "in_channels must be divisible by num_heads (RelativeSelfAttention - Svin V1)"
...
class MOATBlock(nn.Module):
    def __init__(self,
        ...
        # Init Attention
        self.moat_attention = MOATAttention(
